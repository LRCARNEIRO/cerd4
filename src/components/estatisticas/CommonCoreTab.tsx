...
const tabelasDemograficas: CommonCoreTable[] = [
  {
    ...
    dados: {
      ...
      rows: [
        ['População total', '119.002.706', '146.825.475', '169.799.170', '190.755.799', '203.062.512'],
  ...
  },
  {
    ...
    dados: {
      ...
      rows: [
        ['Brasil (total)', '121.150.573', '146.917.459', '169.590.693', '190.755.799', '203.062.512'],
        ['Urbana', '82.013.375', '110.875.826', '137.755.550', '160.925.792', '175.050.912'],
        ['Rural', '39.137.198', '36.041.633', '31.835.143', '29.830.007', '28.011.600'],
  ...
  },
  {
    ...
    dados: {
      ...
      rows: [
        ...
        ['Mulheres', '74.340.353', '86.223.155', '97.348.809', '104.530.081'],
        ['Razão de sexo (H/M)', '0,975', '0,969', '0,959', '0,943']
      ]
    },
    tendencia: 'estavel'
  },
  ...
  },
  {
    ...
    dados: {
      ...
      rows: [
        ['Branca', '75.704.922', '91.298.042', '90.621.281', '88.254.121', '43,5%'],
        ['Preta', '7.335.130', '10.554.336', '14.351.162', '20.656.458', '10,2%'],
        ['Parda', '62.316.085', '65.318.092', '82.820.452', '92.083.286', '45,3%'],
        ['Amarela', '630.658', '761.583', '2.105.353', '850.130', '0,4%'],
        ['Indígena', '294.148', '734.127', '821.501', '1.693.535', '0,8%'],
        ['Negra (Preta+Parda)', '69.651.215', '75.872.428', '97.171.614', '112.739.744', '55,5%']
      ]
    },
    notas: 'População negra = pretos + pardos. Censo 2022 com metodologia ampliada para indígenas.',
    tendencia: 'crescente'
  },
  {
    id: 'cc-10',

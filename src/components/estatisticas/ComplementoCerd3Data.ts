...
export const educacaoIndigena: ComplementoIndicador = {
  ...
  fonte: 'IBGE/Censo 2022 — Tabela SIDRA 4709 (Alfabetização por cor/raça e situação TI)',
  url_fonte: 'https://sidra.ibge.gov.br/tabela/4709#/n1/all/v/93/p/last%201/c2/6794/c86/2776,2777,2778,2779/l/v,p+c2,t+c86',
  artigos_convencao: ['Art.5(e)(v)'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'complementar',
  tendencia: 'estável',
  dados: {
    nota: 'Indígenas em TI: 72,4% alfabetizados vs. 96,5% brancos. Gap de 24,1pp. Fonte: Censo 2022, Tabela SIDRA 4709 (filtro raça × localização TI). Escolas em territórios: Censo Escolar/INEP 2022.',
    alfabetizacao: {
...
export const distorcaoIdadeSerie: ComplementoIndicador = {
  ...
  fonte: 'INEP — Indicadores Educacionais (Distorção Idade-Série por cor/raça, 2019-2023)',
  url_fonte: 'https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/indicadores-educacionais/taxas-de-distorcao-idade-serie',
  artigos_convencao: ['Art.5(e)(v)'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'complementar',
  tendencia: 'melhora',
  dados: {
    nota: 'INEP Dados Abertos → Indicadores Educacionais → Distorção Idade-Série → download CSV por cor/raça. Série 2019-2023, Ensino Fundamental e Médio.',
    fundamental: {
...
export const saudeIndigena: ComplementoIndicador = {
  ...
  fonte: 'DataSUS/SIM-SINASC — TabNet (Óbitos infantis × raça/cor da mãe, 2018-2022)',
  ...
  tendencia: 'piora',
  dados: {
    nota: 'Razão de 2,44× em 2022. TabNet → SIM → Óbitos infantis → Variável: raça/cor da mãe; Período: 2018-2022. Complementado por NCPI/Primeira Infância.',
...
export const processosRacismoCnj: ComplementoIndicador = {
  ...
  categoria: 'legislacao_justica',
  subcategoria: 'Justiça Racial',
  fonte: 'CNJ — Painel Justiça Racial (Módulo "Processos por Assunto", filtro: racismo + injúria racial)',
  url_fonte: 'https://paineisanalytics.cnj.jus.br/single/?appid=dd3d7742-c558-4f2f-8ab1-a10a2e67c48f&sheet=Visão%20Geral',
  artigos_convencao: ['Art.6'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'novo',
  tendencia: 'piora',
  dados: {
    nota: 'Painel CNJ Justiça Racial → Visão Geral → Assunto: "Racismo" + "Injúria racial". 97,4% na Justiça Estadual. Lei 14.532/2023 ampliou tipificação.',
...
export const quilombolasCenso: ComplementoIndicador = {
  ...
  fonte: 'IBGE/Censo 2022 — Tabela SIDRA 9943 (Pop. quilombola por UF e região)',
  url_fonte: 'https://sidra.ibge.gov.br/tabela/9943#/n1/all/n3/all/v/93/p/last%201/l/v,p+t',
  artigos_convencao: ['Art.5', 'Art.2'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'complementar',
  tendencia: 'estável',
  dados: {
    nota: 'Primeiro recenseamento oficial. SIDRA Tabela 9943 → Pop. quilombola por UF. 1,33M. 80,5% no Nordeste.',
...
export const indigenasTisCenso: ComplementoIndicador = {
  ...
  categoria: 'Demografia',
  subcategoria: 'censo_2022_racial',
  fonte: 'IBGE/Censo 2022 — Tabela SIDRA 9587 (Pop. indígena por localização TI)',
  url_fonte: 'https://sidra.ibge.gov.br/tabela/9587#/n1/all/v/93/p/last%201/c86/2779/l/v,p+t',
  artigos_convencao: ['Art.5', 'Art.2'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'complementar',
  tendencia: 'estável',
  dados: {
    nota: 'SIDRA Tabela 9587 → Pop. indígena × localização (dentro/fora de TI). 63,4% vivem fora de TIs — inverte paradigma do III Relatório.',
...
export const religioesMatrizAfricana: ComplementoIndicador = {
  ...
  categoria: 'Cultura',
  subcategoria: 'censo_2022_racial',
  fonte: 'IBGE/Censo 2022 — Tabela SIDRA 9897 (Pop. por religião × UF)',
  url_fonte: 'https://sidra.ibge.gov.br/tabela/9897',
  artigos_convencao: ['Art.5', 'Art.7'],
  documento_origem: ['CERD Observações Finais 2022'],
  tipo: 'complementar',
  tendencia: 'sub-registro',
  dados: {
    nota: 'SIDRA Tabela 9897 → filtro religião: "Umbanda" + "Candomblé". 1,47M adeptos. Sub-registro provável por intolerância.',
...
export const titulacaoQuilombola: ComplementoIndicador = {
  ...
  fonte: 'INCRA — Painel Quilombola (Processos abertos × títulos emitidos)',
  ...
  tendencia: 'piora',
  dados: {
    nota: 'INCRA → Governança Fundiária → Quilombolas → Relatório de processos. Apenas 54 títulos emitidos vs. 1.800 processos abertos.',

          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {totalIndicators} indicadores · StatisticsData + AdmPública + COVID + GruposFocais + Complemento CERD 3 + DadosNovos (Disque 100 / CNJ) · limpeza automática de resíduos a cada espelhamento
              </p>
            </div>
          </div>

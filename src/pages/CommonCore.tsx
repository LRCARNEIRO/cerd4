...
const commonCoreTables: CommonCoreTable[] = [
  ...
  { id: 'cc-46', numero: 46, titulo: 'Taxa de Desocupação', tituloIngles: 'Unemployment rate', categoria: 'Trabalho', fonte: 'IBGE/PNAD', tabelaSidra: 'Tabela 6381', urlFonte: 'https://sidra.ibge.gov.br/tabela/6381', periodoOriginal: '2012-2019', periodoAtualizado: '2012-2024', statusAtualizacao: 'atualizado', tendencia: 'decrescente', dadosColetados: true, ultimaAtualizacao: '2024-01' },

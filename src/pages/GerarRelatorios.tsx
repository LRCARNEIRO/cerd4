...
import { useLacunasIdentificadas, useRespostasLacunasCerdIII, useLacunasStats, useConclusoesAnaliticas, useIndicadoresInterseccionais, useOrcamentoCanonico, useOrcamentoStats } from '@/hooks/useLacunasData';

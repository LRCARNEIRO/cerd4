...
export const SUB_INDICADORES: SubIndicadorEntry[] = [
  ...
  { codigo: 'IND-197', guardaChuva: 'População carcerária por raça/cor', sub: 'população carcerária negra', titulo: 'População carcerária negra (%)', tabValue: 'grupos-focais', abaLabel: 'Grupos Focais', subTab: 'serie-temporal', subTabLabel: 'Série Temporal', aliases: ['jovens negros na população carcerária', 'encarceramento juvenil negro', '19º Anuário FBSP 2025'] },
  ...
  { codigo: 'IND-118', guardaChuva: 'Saúde materna — raça e gênero', sub: 'mortes maternas brancas', titulo: 'Mortes maternas brancas', tabValue: 'raca-genero', abaLabel: 'Raça × Gênero', aliases: ['mortalidade materna branca'] },
